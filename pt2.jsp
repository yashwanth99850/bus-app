...
<head>
    ...
    <ul>
		...
		<li><a href="pt1.html"class="active">Print Ticket </a></li>
...
<%
	Connection con=null;
	String bid1= (String)session.getAttribute("boid");
	try
	{
...
%>		
		...
		<tr>
		<th align=center ><h1><a href="#"><input type="button" value="PRINT"></a></h1></th>
		</tr>
			<tr>
